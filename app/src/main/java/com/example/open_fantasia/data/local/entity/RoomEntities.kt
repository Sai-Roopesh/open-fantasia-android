...
data class ThreadEntity(
    ...
    /** The authored intention. The transport ceiling is derived from it, never stored. */
    val reply_length: String = "full",
    /** What the player wants to happen next, as encoded [StoryDirection]. Never model-authored. */
    val story_direction: String = "",
...
data class BranchEntity(
    ...
    /** What the current scene is for. Carried until changed, like the Active Speaker beside it. */
    val scene_intent: String = "develop"
) {
}
...
data class TurnEntity(
    ...
    /**
     * What the reply reported about the scene it left behind, as stored JSON. Null when the model wrote
     * no report or wrote one that could not be read; the Stage then falls back to snapshot presence.
     */
    val scene_report: String? = null
) {
}
